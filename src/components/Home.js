        ...
        <div className="app">
            ...
            <div className="app__header">
                ...
                {user ? (
                    ...
                    <div>
                        <Button variant="contained" color='primary' disableElevation onClick={() => setOpensignin(true)}>Ingresa</Button>
                        <span>&nbsp;</span>
            ...
            {user && user.displayName ? (
                ...
                <div className='unauth'>
                    <b onClick={() => setOpensignin(true)} style={{ cursor: 'pointer', color: 'deepskyblue' }}>Ingresa</b> o <b onClick={() => setOpen(true)} style={{ cursor: 'pointer', color: 'deepskyblue' }}>Crear una cuenta</b> Para poder agregar un Post
                </div>
            )}
